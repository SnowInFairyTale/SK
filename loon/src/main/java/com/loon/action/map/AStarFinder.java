...
import com.loon.action.map.heuristics.Closest;
import com.loon.action.map.heuristics.ClosestSquared;
import com.loon.action.map.heuristics.Diagonal;
import com.loon.action.map.heuristics.DiagonalShort;
import com.loon.action.map.heuristics.Euclidean;
import com.loon.action.map.heuristics.EuclideanNoSQR;
import com.loon.action.map.heuristics.Manhattan;
import com.loon.action.map.heuristics.Mixing;
